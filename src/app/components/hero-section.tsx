...
const floatingCards = [
  ...
  { id: 3, image: "/nft-3.jpg", rotation: -5, x: 40, y: 140, z: 1 },
]
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-pretty text-lg leading-relaxed text-muted-foreground sm:text-xl">
              Discover, collect, and trade unique digital artworks from the world&apos;s
              most creative artists. Build your ultimate NFT collection today.
            </p>
          ...
          {/* Right content - Floating NFT Cards */}
